...
const app = initializeApp(firebaseConfig);
  ...
  export const getProducts = (callback) => onSnapshot(collection(db,"salida"), callback);

  
export const sendProduct = async (product) => await setDoc(doc(db,'salida',`${name.value}`),product);
